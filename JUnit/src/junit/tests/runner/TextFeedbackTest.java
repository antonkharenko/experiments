...
public class TextFeedbackTest extends TestCaseRef {
	OutputStream output;
	TestRunner runner;
	...
	public void testOneTest() {
		...
		suite.addTest(new TestCaseRef() { public void runTest() {}});
		runner.doRun(suite);
		assertEquals(expected.toString(), output.toString());
	}
	...
	public void testFailure() {
		...
		TestSuite suite = new TestSuite();
		suite.addTest(new TestCaseRef() { public void runTest() {throw new AssertionFailedError();}});
		runner.doRun(suite);
		assertEquals(expected.toString(), output.toString());
	}
	...
	public void testError() {
		...
		runner.setPrinter(printer);
		TestSuite suite = new TestSuite();
		suite.addTest(new TestCaseRef() { public void runTest() throws Exception {throw new Exception();}});
		runner.doRun(suite);
		assertEquals(expected.toString(), output.toString());
	}
